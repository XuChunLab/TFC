...
%% dca 1 trace peak activity delay time 
clc;clear;
filepath= 'D:\miniscope analysis\bt_miniscope\dca1\sigraw\combine2\method5\conditioning5';% working path
% filenames=dir([ filepath, '\*.mat']);
load(fullfile(filepath,'cond_sdff_cell.mat'));load(fullfile(filepath,'cond_sdff_data.mat')); % load these three mat files (no matter where they are, put them into the working path first).
...
trial1_0_10=trial1(trial1<10);
trial1_10_20=trial1(trial1>=10);
