...
% addpath D:\miniscope analysis\Find_ROI
clc;clear;
% load example data [processed_xxxx.mat]
load('processed_306705.mat'); % put the data to the working path
load ('habituation_sdff_cell.mat');
load('habituation_sdff_data');
load('habituation_poolTogether.mat');
%% habituation session
